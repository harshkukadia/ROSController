<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="KeyboardSettings.aspx.cs" Inherits="VirtualJoystickProperties" %>
    ...
    <header>
        <nav>
            <div class="nav-wrapper">
                ...
                <%--Back Button--%>
                <a href="Keyboard.aspx" class="left"><i class="mdi-hardware-keyboard-backspace"></i></a>
            </div>
        </nav>
    </header>
