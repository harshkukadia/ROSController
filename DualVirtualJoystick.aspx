<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DualVirtualJoystick.aspx.cs" Inherits="ext" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    ...
    <header>
        <nav>
            <div class="nav-wrapper">
                ...
                <a href="DualVirtualJoystickSettings.aspx" class="hide-on-large-only right"><i class="mdi-action-settings"></i></a>
                <ul class="side-nav" id="mobile-demo">
                    ...
                    <li><a href="DualVirtualJoystickSettings.aspx"><i class="mdi-action-settings left"></i>Settings</a></li>
    ...
    <div class="container">
        ...
        <%--Controller Name--%>
        <h4 class="center-align center">Dual Virtual Joysticks</h4>
        <br /> 
        <%--Information--%>
        <p class="center-align flow-text hide-on-large-only">Touch on the right or left side of the screen and drag to move both the joysticks<br /><br />You can change your settings by clicking the gear icon in the top right corner</p>
        <p class="center-align flow-text hide-on-med-and-down">Touch on the right and left side of the screen and drag to move both the joysticks<br /><br />You can change your settings by clicking on settings in the top right corner</p>
    </div>
    ...
    <%--Initialize iframe--%>
    <div id="content">
        <iframe width="100%" height="100%" frameborder="0" src="DualVirtualJoystick.html"> </iframe>
    </div>
